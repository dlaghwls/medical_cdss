...
class Visit(models.Model):
    ...
    # 의료진 정보
    attending_doctor = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, verbose_name="담당의")
...
class VitalSigns(models.Model):
    ...
    measured_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, verbose_name="측정자", related_name='patient_vitalsigns')
